...
public class UserMaster extends RealmObject {
    ...
    String fathersName;
    String mothersName;
    String fathersFathersName;
    String fathersMothersName;
    String mothersFathersName;
    String mothersMothersName;
    String mothersFathersSurname;
    String mothersFathersVillage;
    String husbandsName;
    String husbandsFathersName;
    String husbandsMothersName;
    String wifesName;
    String wifesFathersName;
    String wifesMothersName;
    String wifesFathersSurname;
    String wifesFathersVillage;
    String homePhone;
    String address;
    String currentArea;
    Integer cityId;
    ...
    Integer pincode;
    Integer businessId;
    String businesssubcategoryids;
    String businessName;
    String educationName;
    String educationSpecialization;
    Integer usertypeId;
    String createdDate;
    Boolean appovalStatus;
    String hobbyId;
    String gender;
    ...
    public UserMaster getUserData(Realm realm,long userid) {
        ...
        try {
            ...
            userData = realm.where(UserMaster.class).equalTo("userid", userid).findFirst();
            //Toast.makeText(context, "userid : "+userData.getUserid(), Toast.LENGTH_SHORT).show();
            //userData = UserMaster.asObservable() realm.where(UserMaster.class).equalTo("", Long.parseLong(userDetails.get(SessionManager.KEY_USER_ID)));
