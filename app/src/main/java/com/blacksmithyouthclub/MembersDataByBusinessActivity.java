...
public class MembersDataByBusinessActivity extends AppCompatActivity {
    ...
    private String TAG = MembersDataByBusinessActivity.class.getSimpleName();
    private SurnameWiseMemberDataAdapterRecyclerView adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_members_data_by_business);
        ...
        getMemebersDataByBusinessSubcategoryId();
    ...
    private void getMemebersDataByBusinessSubcategoryId() {
        ...
        apiClient.getAllUsersByBusinessSubCategoryId("user", userDetails.get(SessionManager.KEY_SELECTED_BUSINESS_SUBCATEGORY_ID)).enqueue(new Callback<MembersDataBySurname>() {
            ...
            public void onResponse(Call<MembersDataBySurname> call, Response<MembersDataBySurname> response) {
                ...
                Log.d(TAG, "getAllUsersByBusinessSubCategoryId Response Code : " + response.code());
